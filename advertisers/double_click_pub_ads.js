(function() {
    ...
    var na = function(a) {
        ...
        wa = function(a) {
            if (!pa.test(a)) return a; - 1 != a.indexOf("&") && (a = a.replace(qa, "&amp;")); - 1 != a.indexOf("<") && (a = a.replace(ra, "&lt;")); - 1 != a.indexOf(">") && (a = a.replace(sa, "&gt;")); - 1 != a.indexOf('"') && (a = a.replace(ta, "&quot;")); - 1 != a.indexOf("'") && (a = a.replace(va, "&#39;"));
            return a
        },
        qa = /&/g,
        ra = /</g,
    ...
    var C = Array.prototype,
        ...
        bb = function(a) {
            for (var b = {}, c = 0, d = 0; d < a.length;) {
                var e = a[d++],
                    f = ea(e) ? "o" + (e[fa] || (e[fa] = ++ga)) : (typeof e).charAt(0) + e;
    ...
    t: {
        var ub = "",
            vb;
        if (qb && q.opera) var wb = q.opera.version,
            ub = "function" == typeof wb ? wb() : wb;
        else if (rb ? vb = /rv\:([^\);]+)(\)|;)/ : F ? vb = /\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/ : G && (vb = /WebKit\/(\S+)/), vb) var xb = vb.exec(nb()),
            ub = xb ? xb[1] : "";
        if (F) {
            var yb = sb();
            if (yb > parseFloat(ub)) {
    ...
    var zb = tb,
        ...
        Bb = q.document,
        Cb = Bb && F ? sb() || ("CSS1Compat" == Bb.compatMode ? parseInt(zb, 10) : 5) : void 0;
    var Db = !F || F && 9 <= Cb,
        Eb = !rb && !F || F && F && 9 <= Cb || rb && H("1.9.1");
    F && H("9");
    var Fb = function(a, b) {
        var c;
        c = a.className;
        c = s(c) && c.match(/\S+/g) || [];
        for (var d = ab(arguments, 1), e = c.length + d.length, f = c, g = 0; g < d.length; g++) 0 <= Ra(f, d[g]) || f.push(d[g]);
        a.className = c.join(" ");
        return c.length == e
    };
    var Ib = function(a) {
    ...
    var Wb = function(a, b) {
        ...
        $b = function(a) {
            var b = [],
                c = a.a.getTargetingMap(),
                d;
            for (d in c) {
                for (var e =
                        c[d], f = [], g = 0; g < e.length; ++g) f.push(encodeURIComponent(e[g]));
                b.push(encodeURIComponent(d) + "=" + f.join(","))
            }
            if (u(a.a.getCategoryExclusions) && (a = a.a.getCategoryExclusions(), 0 < a.length && !("excl_cat" in c))) {
                c = [];
                for (g = 0; g < a.length; ++g) c.push(encodeURIComponent(a[g]));
                ...
                try {
                    ...
                    try {
                        ...
                        if (e.stack) {
                            ...
                            try {
                                -1 == h.indexOf(c) && (h = c + "\n" + h);
                                for (var k; h != k;) k = h, h = h.replace(/((https?:\/..*\/)[^\/:]*:\d+(?:.|\n)*)\2/, "$1");
                                g = h.replace(/\n */g, "\n")
                            } catch (l) {
                                g = c
                            }
    ...
    var oc = !!window.google_async_iframe_id,
        ...
        Ja = function() {
            if (oc && !Qa(pc)) {
                for (var a = "." + ka.domain; 2 < a.split(".").length && !Qa(pc);) ka.domain = a = a.substr(a.indexOf(".") + 1), pc = window.parent;
                Qa(pc) || (pc = window)
            }
            return pc
        };
    var qc = function(a) {
            this.b = [];
            this.a = {};
            for (var b = 0, c = arguments.length; b < c; ++b) this.a[arguments[b]] = ""
        },
        rc = function(a, b, c) {
    ...
    var tc = function(a) {
        ...
        wc = function(a) {
            ...
            if (vc[a]) return vc[a];
            if ("google_persistent_state_async" == a) var b = Ja(),
                c = {};
            else c = b = Ja();
            var d = b[a];
    ...
    var zc = RegExp("^(?:([^:/?#.]+):)?(?://(?:([^/?#]*)@)?([^/#?]*?)(?::([0-9]+))?(?=[/#?]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#(.*))?$"),
        ...
        Bc = function(a) {
            if (Ac) {
                ...
                if (b) {
                    var c = b.href;
                    if (c && (c = (c = Bc(c)) && decodeURIComponent(c)) && c != b.hostname) throw Ac = !0, Error();
                }
            }
    ...
    var Dc = function(a, b) {
        ...
        Gc = function(a) {
            ...
            for (a = a.parentNode; a && a != b; a = a.parentNode)
                if (c = Ec(a, "position"), d = d && "static" == c && a != b.documentElement && a != b.body, !d && (a.scrollWidth > a.clientWidth || a.scrollHeight > a.clientHeight || "fixed" == c || "absolute" == c || "relative" == c)) return a;
            return null
        },
        Hc = function(a) {
            var b, c = Hb(a),
                d = Ec(a, "position"),
                e = rb && c.getBoxObjectFor && !a.getBoundingClientRect && "absolute" == d && (b = c.getBoxObjectFor(a)) &&
            ...
            if (a == g) return f;
            if (a.getBoundingClientRect) b = Fc(a), a = Sb(Ib(c)), f.x = b.left + a.x, f.y = b.top + a.y;
                ...
                if (qb || G && "absolute" == d) f.y -= c.body.offsetTop;
                for (e = a;
                    (e = Gc(e)) && e != c.body && e != g;) f.x -= e.scrollLeft, qb && "TR" == e.tagName || (f.y -= e.scrollTop)
            }
            return f
        },
        Ic = function(a) {
    ...
    p.getRegisteredAdblockUrls = function() {
        for (var a = [], b = this.a.length, c = 0; c < b; c++) a.push(this.a[c].c);
        return a
    };
    ...
    var O = q.googletag._vars_,
        Rc = O[7],
        Sc = O[8],
        Ga = [O[6] ? "https" : "http", "://", O[1], "/pagead/osd.js"].join(""),
        Lc = Rc,
        Mc = Sc;
    var Tc = function(a) {
            var b = a;
    ...
    jd.prototype.toString = function() {
        ...
        for (var e in this.c) u(this.c[e]) || b.push("[" + e + "," + this.c[e] + "]");
        a += b.join();
        return a + "]"
    };
    var rd = function(a, b) {
                ...
                if (c) try {
                    ...
                    do {
                        ...
                        if (g == e) k = Hc(c);
                            ...
                            var l = c,
                                h = void 0;
                            if (l.getBoundingClientRect) var m = Fc(l),
                                h = new D(m.left, m.top);
                            else var n = Sb(Ib(l)),
                                t = Hc(l),
            ...
            switch (typeof b) {
                ...
                case "object":
                    ...
                    if (ca(b)) {
                        var d = b.length;
                        c.push("[");
                        for (var e = "", f = 0; f < d; f++) c.push(e), Pd(a, b[f], c), e = ",";
                        c.push("]");
                        break
                    }
                    c.push("{");
                    d = "";
                    for (e in b) Object.prototype.hasOwnProperty.call(b, e) && (f =
    ...
    */
    ...
    ye.prototype.send = function(a, b) {
        var c = a + ":" + b;
        if (!F || 3800 >= b.length) this.a.push("|" + c);
        else
            for (var d = b.length, e = Math.ceil(d / 3800), f = 0, g = 1; f < d;) this.a.push("," + g + "/" + e + "|" + c.substr(f, 3800)), g++, f += 3800;
    ...
    var Ae = [],
        Be = v(function() {
            var a, b = !1;
            try {
                for (var c = 0; a = Ae[c]; c++) b = b || a.b()
            } catch (d) {
                if (a.a.d.a(), !Ae.length) return
            }
            a = ja();
            b && (ze = a);
    ...
    var Ge = function(a, b, c, d) {
        ...
        var e = window.screenX || window.screenLeft || 0,
            f = window.screenY || window.screenTop || 0,
            e = new kc(f, (window.outerWidth || document.documentElement.clientWidth || 0) - e, (window.outerHeight || document.documentElement.clientHeight || 0) - f, e),
            f = Hc(a),
            g;
        if ("none" != Ec(a, "display")) g = Jc(a);
        else {
            g = a.style;
            var h = g.display,
                k = g.visibility,
        ...
        for (var h = String(Ec(a, "zIndex")), k = new kc(0, Infinity, Infinity, 0), l = Ib(a), n = l.a.body, t = l.a.documentElement, m = Nb(l.a); a = Gc(a);)
            if (!(F && 0 == a.clientWidth || G && 0 == a.clientHeight && a == n || a == n || a == t || "visible" == Ec(a, "overflow"))) {
                ...
                if (rb && !H("1.9")) {
                    ...
                    if ("rtl" == Ec(w, "direction")) var A =
                        w.offsetWidth - w.clientWidth - L - parseFloat(Dc(w, "borderRightWidth")),
                        L = L + A;
                    w = new D(L, parseFloat(Dc(w, "borderTopWidth")))
                } else w = new D(w.clientLeft, w.clientTop);
                r.x += w.x;
                r.y += w.y;
        ...
        k = null;
        if (null != a) t: {
            n = new Cc(a.left, a.top, a.right - a.left, a.bottom - a.top);k = Math.max(n.left, f.left);l = Math.min(n.left + n.width, f.left + f.width);
        ...
        h = Ob(e.a);
        for (a = 0; h != h.parent;) a++, h = h.parent;
        (h = a) && (g += "?n=" + h);
        b = {
            id: b,
            name: c + f,
    ...
    R.prototype.q = function(a) {
        if (!ca(a)) return "";
        if ("sra" == this.f) 0 == a.length && (a = ld(this.b));
        else {
        ...
        a = this.d;
        if (2048 < a.length) {
            var b = a.lastIndexOf("&", 2040); - 1 != b ? a = a.substring(0, b) : (a = a.substring(0, 2040), a = a.replace(/%\w?$/, ""));
            a += "&trunc=1"
        }
        return a
    };
    R.prototype.k = function(a) {
        ...
        if ("sra" == this.f) {
            ...
            b = [];
            for (c = 0; c < a.length; ++c) b.push(Zb(a[c]));
            S(this, "prev_iu_szs", b.join());
            if (a.length) {
                b = "";
                for (c = 0; c < a.length; ++c) b += a[c].a.getOutOfPage() ? "1" : "0";
                b = parseInt(b, 2)
            } else b = 0;
            b && S(this, "ists", b);
            He(this);
            c = null;
            b = [];
            for (c = 0; c < a.length; ++c) b.push($b(a[c]));
            c = b.join("|");
            c.length == b.length - 1 && (c = null);
            S(this, "prev_scp", c)
        } else b = a[0].a.gtfcd(), -1 !== b && S(this, "tfcd", b), b = a[0], S(this, "iu", b.b), S(this, "sz", Zb(b)), b.a.getClickUrl() && S(this, "click", b.a.getClickUrl()), b.a.getOutOfPage() && S(this, "ists", "1"), b in this.b.d && S(this, "logonly", "1"), He(this), b = a[0], c = $b(b), S(this, "scp", c), b = b.a.getAudExtId(), 0 < b && S(this, "audextid", b);
        b = 0;
        this.a.j && (b |= 1);
        a[0].o && (b |= 2);
        0 < b && S(this, "eri", b);
        ...
        var c = document,
            ...
            f = [],
            l;
        for (l in d.c) u(d.c[l]) || f.push(B(l) + "=" + B(d.c[l]));
        ...
        for (var t in l) m = l[t], u(m) || T(this, t, m);
        q.devicePixelRatio &&
        ...
        if ("sra" == this.f) {
            t = a.length;
            r = [];
            for (m = 0; m < t; m++) l = Xc(a[m]), a[m].i = l, r.push(l);
            S(this, "adks",
                r.join(","))
        }
        a = q.googletag;
    ...
    R.prototype.i = function(a, b) {
        ...
        if (c = lc(!0)) S(this, "biw", c.width), S(this, "bih", c.height);
        this.a.d && S(this, "oid", this.a.d);
        if ("sra" != this.f) {
            if (c =
                td(this.b, b[0])) S(this, "adx", Math.round(c.x)), S(this, "ady", Math.round(c.y));
    ...
    Ie.prototype.k = function(a) {
        ...
        var b = a.document.domain,
            ...
            c = window.google_analytics_domain_name,
            b = "undefined" == typeof c ? Ld("auto", b) : Ld(c, b),
            k = -1 < d.indexOf("__utma=" + b + "."),
            l = -1 < d.indexOf("__utmb=" + b),
            c = wc("google_persistent_state"),
            c = yc(c) || (c.S[xc(14)] = {}),
            m = !1;
        if (k) g = d.split("__utma=" + b + ".")[1].split(";")[0].split("."), l ? c.u = g[3] + "" : c.u || (c.u = h + ""), c.v = g[0] + "." + g[1], c.Z = !0;
        else {
            c.u || (c.u = h + "");
            if (!c.v) {
                m = !0;
        ...
        if (!c.la) {
            ...
            t: {
                h = 999;
                if (g = window.google_analytics_domain_name) g = 0 == g.indexOf(".") ? g.substr(1) : g,
                h = ("" + g).split(".").length;g = 999;d = d.split(";");
                ...
                if (d) {
                    ...
                    try {
                        ...
                        if (6 < parseInt(Wc(), 10) || 0 > f.indexOf("http://" + O[1] + "/pagead/inject_object_div.js")) {
                            ...
                            if (k) {
                                var A = unescape(encodeURIComponent(f)),
                                    ua = Math.floor(A.length / 2);
                                a = [];
                                for (k = 0; k < ua; ++k) a[k] = String.fromCharCode(256 * A.charCodeAt(2 * k + 1) + A.charCodeAt(2 * k));
    ...
    Se.prototype.k = function(a, b, c) {
        ...
        if (this.b)
            if (ca(a)) {
                ...
                for (e in d = [], a) {
                    if (b = a[e], !u(b) && (c = Xe(this, e))) We(this, c, b), d.push(c)
                } else e = gb(a), 1 < e.length || 0 == e.length ? a = null : (e = e[0], a = a[e], (b = b ? this.a.a[b] : Xe(this, e)) ? (We(this, b, a), a = b) : a = null), a && d.push(a);
        return d
    };
        ...
        Xe = function(a, b) {
            ...
            if (c = d.length ? d : null)
                for (d = 0; d < c.length; ++d)
                    if ((e = a.a.a[b + "_" + c[d]]) && !a.c[I(e)]) return e;
            return null
        };
    var Ye = function(a, b) {
            var c = Vc();
    ...
    U.prototype.N = function() {
        var a = Se.prototype.N.call(this),
            b = Qc().getOseExpId();
        b && a.push(b);
        return a
    };
    U.prototype.n = function() {
        ...
        var a = pd(this.a);
        if (0 < a.length) {
            for (var b = {}, c = [], d = 0; d < a.length; ++d) b[a[d][0]] = !0;
            for (var e in b) u(e) || c.push(e);
    ...
    var ff = function(a, b, c) {
            ...
            var d = "";
            if (!(b in a.a.d)) {
                var d = d + '<script type="text/javascript">function callbackProxy(adContents) { ',
                    e;
                e = I(b);
                e = String(e);
                if (e.quote) e = e.quote();
                else {
    ...
    V.prototype.ja = function(a, b, c, d, e, f) {
        ...
        e && (this.D = !0);
        f && (this.I = f);
        for (b = 0; b < a.length; b++) this.c[I(a[b])] = null;
        od(this.a, a);
    ...
    var mf = function(a, b) {
            ...
            if (0 != d.length) {
                var e = d[0];
                if (1 < d.length) {
                    t: if (d = J(b), (d = (c || document).getElementById(d)) && d.style.height && d.style.width)
        ...
        of = function(a, b) {
            ...
            for (var c = 0; c < a.t.length; ++c) {
                var d = a.t[c];
                if (nf(d, b)) return C.splice.call(a.t, c, 1), d
            }
            return null
        },
        qf = function(a, b, c) {
    ...
    var rf = function(a, b) {
        ...
        kf = function(a, b, c, d) {
            if (a.b) {
                if (!a.j && (!a.l || d)) {
                    for (var e = 0; e < b.length; e++) nd(a.a, b[e]), mf(a, b[e]);
                    d = a.q(b, d);
                    d = Tc(d);
                    Ue(a, b);
    ...
    V.prototype.U = function(a) {
        ...
        if (this.b) {
            rf(this, a);
            if (1 == this.a.b.length) b = ld(this.a);
            else return;
            ...
            try {
                t: {
                    var c = window,
                        d = document,
                        e = a.c[I(b)];Xb(b);
                    if (null == e || e._empty_) a.o(c, d, b, a.I),
                    Q(b, bc(b));
                    else if (a.B) Q(b, bc(b));
                    else {
                        var f = e._html_;
                        if (!s(f)) {
                            jf(b);
                        ...
                        if (e._use_safe_frame_) {
                            var h =
                                e._width_,
                                k = e._height_,
                                l = d.getElementById(gf(b));
                            if (null != l) {
                                for (var m; m = l.firstChild;) l.removeChild(m);
                                c = f;
                                c = Ne(c);
                    ...
                    if (0 == Wc()) Je || (Je = null),
                    Je.a("iFrame not removed as non-IE browser, id: " + r);
                    else {
    ...
    var tf = function(a, b, c) {
        b = a.k(b);
        if (a.b) c = a.a.b, 1 == c.length && sf(a, c[0], void 0);
        else
            for (var d = 0; d < b.length; ++d) sf(a, b[d], c)
    };
    ...
    var sf = function(a, b, c) {
            var d = window,
                ...
                f = a.c[I(b)];
            Xb(b);
            if (null == f || f._empty_) a.o(d, e, b, !1), Q(b, bc(b));
            else if (a.B) Q(b, bc(b));
            ...
            } else if (f._snippet_ && !f._is_afc_) uf(b, e), f = a.c[I(b)], null !=
                ...
                if (d = P(a.d, "google_domain_reset_url"))
                    if (g = (g = Bc(d)) && decodeURIComponent(g), null === g || 0 <= g.indexOf(document.domain)) c = d;
                k = c;
                c = f._width_;
                f = f._height_;
                d = a.g;
            ...
            } else uf(b, document), f = vf(a, b, document), e.write('<script>googletag.impl.pubads.createDomIframe("' + f + '" ,"' + I(b) + '",' + a.g + "," + c + ");\x3c/script>")
        },
        vf = function(a, b, c, d) {
            b = J(b) + "_ad_container";
            var e = "<div id=" + b;
    ...
    x("googletag.impl.pubads.setAdContentsBySlotForAsync", function(a, b) {
        ...
        if (c.b) qf(c, a, b);
            ...
            for (var d = c.k(a, b), e = c.f[0], f = !1, g = 0; g < d.length; ++g) pf(c, d[g]), d[g] === e && (f = !0);
