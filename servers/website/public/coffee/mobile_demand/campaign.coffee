class Dashboard
  ...
  constructor: ->
    @$search = $(".mobile-display .search-box input")
    @$table = $(".mobile-display .table-body table").show()
  ...
  update: ->
    ...
    $.get("/m/dashboard/demand/#{config.advertiser}/campaign/#{config.campaign}/charts").done (response)=>
